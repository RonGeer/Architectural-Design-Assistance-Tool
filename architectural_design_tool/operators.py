...
class Branch(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        w2 = fun.randomValue(props.min_size*props.add_box_size, props.max_size*props.add_box_size)
        w3 = fun.randomValue(props.min_size*props.add_box_size, props.max_size*props.add_box_size)
